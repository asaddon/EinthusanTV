    ...
    <div class="dark">
        ...
        <div id="installModal" ref="installModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-lg h-full md:h-auto">
                <!-- Modal content -->
                <div class="relative bg-black/90 backdrop-blur-xl border border-red-500/30 rounded-2xl shadow-[0_0_40px_rgba(239,68,68,0.2)] overflow-hidden">
                    ...
                    <div class="p-6 space-y-4 text-center">
                        ...
                        <div class="mt-4 p-4 bg-gradient-to-r from-gray-800/80 to-gray-900/80 rounded-2xl border border-orange-500/20 shadow-lg inline-block max-w-sm">
                            ...
                            <a href='https://ko-fi.com/W7W2166YEP' target='_blank' class="inline-block hover:scale-105 transition-transform duration-300">
                                <img src='https://storage.ko-fi.com/cdn/kofi3.png?v=3' class="h-10 shadow-[0_0_15px_rgba(249,115,22,0.3)] rounded-lg" alt='Buy Me a Coffee' />
                            </a>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center justify-end p-6 space-x-3 rounded-b border-t border-gray-700/50 bg-black/50">
                        ...
                        <a id="install_button" href="#" @click="methods.trackInstall()">
                            <button type="button"
                                class="text-white bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 focus:ring-4 focus:outline-none focus:ring-red-800 font-semibold rounded-lg text-sm px-6 py-2.5 text-center shadow-[0_0_15px_rgba(239,68,68,0.5)] transition-all">
                                Install Now
                            </button>
                        </a>
                    </div>
                    <div class="px-6 pb-6 space-y-4">
                        <div class="relative">
                            <input type="text" id="install_link" readonly :value="state.httpsUrl"
                                class="bg-gray-800/50 border border-gray-700 text-gray-300 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 pr-24" />
        ...
        <!-- Main Content -->
        <div class="relative min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8 bg-no-repeat bg-cover bg-center font-sans"
            ...
            <div class="relative z-10 w-full max-w-2xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] rounded-3xl p-8 sm:p-12">
                ...
                <div class="flex flex-col items-center text-center mb-8">
                    ...
                    <span class="mt-2 px-3 py-1 text-xs font-semibold text-red-200 bg-red-900/40 rounded-full border border-red-500/30">
                        v{{ manifest.version }}
                    </span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 text-sm text-gray-300">
                    <div class="bg-gray-800/40 rounded-xl p-5 border border-white/5">
                        ...
                        <ul class="space-y-2 pl-6 list-disc marker:text-orange-500 text-xs">
                            <li>Recently Added Movies Catalog</li>
                            <li>Rating Poster Database Integration</li>
                        </ul>
                    </div>
                    <div class="bg-gray-800/40 rounded-xl p-5 border border-white/5">
                        <h3 class="text-orange-400 font-semibold mb-3 flex items-center">
                        ...
                        <ul class="space-y-2 pl-6 list-disc marker:text-red-500 text-xs">
                ...
                <div class="space-y-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <label v-for="language in state.languages" :key="language" class="cursor-pointer">
                                ...
                                <div class="rounded-xl border border-gray-600 bg-black/60 px-4 py-3 text-center text-sm font-medium text-gray-300 transition-all hover:bg-gray-800 peer-checked:border-red-500 peer-checked:bg-red-900/30 peer-checked:text-white shadow-sm">
                    ...
                    <div class="bg-gray-800/30 rounded-xl p-5 border border-white/5">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="https://ratingposterdb.com/" target="_blank" class="text-xs text-red-400 hover:text-orange-400 hover:underline transition-colors">Get API Key</a>
                        </div>
                        ...
                        <form @submit.prevent="methods.ValidateRPDB" class="flex flex-col sm:flex-row gap-3">
                            <div class="relative flex-1">
                                <input v-model="state.RPDBkey.key" @input="state.RPDBkey.valid = null" type="text"
                                    class="block w-full bg-black/60 border border-gray-600 text-white text-sm rounded-xl focus:ring-orange-500 focus:border-orange-500 p-3.5 transition-all duration-300 placeholder-gray-500"
                ...
                <div class="mt-10 pt-8 border-t border-gray-700/50 text-center">
                    ...
                    <button :disabled='isInstallDisabled'
                        ...
                        class="w-full sm:w-auto min-w-[250px] text-white bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 focus:outline-none focus:ring-4 focus:ring-red-800 font-bold rounded-2xl text-lg px-8 py-4 shadow-[0_0_30px_rgba(239,68,68,0.4)] hover:shadow-[0_0_45px_rgba(249,115,22,0.6)] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none transition-all duration-300 transform hover:-translate-y-1">
                        Install Addon
                    </button>
                    <p class="text-center text-xs text-white mt-6 max-w-sm mx-auto leading-relaxed">
                        <span class="text-orange-400 font-semibold">Note:</span> Clicking "Install Addon" above will open a single advertisement in a new tab to help keep this addon free.<br>
                    ...
                    <!-- Server Support CTA -->
                    <div class="mt-8 p-5 bg-gradient-to-r from-gray-800/80 to-gray-900/80 rounded-2xl border border-orange-500/20 shadow-lg max-w-lg mx-auto">
                ...
                <div class="mt-12 text-center text-xs text-white space-y-1">
                    <p>Recreated by <a href="https://github.com/asaddon" target="_blank" class="text-red-400 hover:text-orange-400 font-semibold transition-colors">asaddon</a></p>
                    <p class="opacity-60">
                ...
                <div class="mt-10 p-5 bg-gray-800/40 rounded-2xl border border-gray-700/50 shadow-inner w-full max-w-2xl mx-auto backdrop-blur-sm">
                    ...
                    <div class="flex justify-center min-h-[100px] w-full rounded-xl overflow-hidden bg-black/60 relative">
